...
export const Header = () => {
    return (
        <header className={styles.header}>
            ...
            <div className={styles.header__jumbotron}>
                <div className={styles.header__jumbotron__wrapContent}>
                    <h1>
                        FC Barcelona is a Spanish professional football club
                        from Barcelona.
                    </h1>
                    <p>
                        They are known for winning the treble (La Liga, the Copa
                        Del Rey, and the UEFA Champions League) all in 1 season,
                        twice, in the 2008-09 season and in the 2014-15 season.
                        Their biggest rival is Real Madrid.
                    </p>
                    <div
                        className={
                            styles.header__jumbotron__wrapContent__wrapBtn
                        }
                    >
                        <Button text="Sign up" />
                    </div>
